...
MISSING_SERVICE_URL = 'Missing required environment variable: SLURRY_SLACK_SERVICE_URL'
MISSING_MANAGER_URL = 'Missing required environment variable: SLURRY_SLACK_MANAGER_URL'
...
class Command
  getOptions: =>
    ...
    throw new Error MISSING_SERVICE_URL if _.isEmpty process.env.SLURRY_SLACK_SERVICE_URL
    throw new Error MISSING_MANAGER_URL if _.isEmpty process.env.SLURRY_SLACK_MANAGER_URL
    ...
    return {
      ...
      serviceUrl:      process.env.SLURRY_SLACK_SERVICE_URL
      userDeviceManagerUrl: process.env.SLURRY_SLACK_MANAGER_URL
      staticSchemasPath: process.env.SLURRY_SLACK_STATIC_SCHEMAS_PATH
    }
